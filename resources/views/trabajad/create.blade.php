    ...
    <div class="container-fluid">
        ...
        <form class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    {!! Form::text('nombre',null,['class'=>'form-control','placeholder'=>'Nombre del Trabajador']) !!}
                </div>
                <div class="col-sm-3">
                    {!! Form::text('nombre',null,['class'=>'form-control','placeholder'=>'Apellido Paterno']) !!}
                </div>
                <div class="col-sm-3">
                    {!! Form::text('nombre',null,['class'=>'form-control','placeholder'=>'Apellido Materno']) !!}
                </div>
            </div>
            <div class="form-group">
                {!! Form::label('ESTADO CIVIL',null,['class'=>'control-label col-sm-3']) !!}
                <div class="col-sm-3">
                    {!! Form::select('civil',['S'=>'Soltero','C'=>'Casado'],'S',['class'=>'form-control']) !!}
                </div>
                <div class="col-sm-3">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <div class="col-sm-6">
                        {!! Form::text('nombre',null,['class'=>'form-control','placeholder'=>'Num Ext']) !!}
                    </div>
                    <div class="col-sm-6">
                        {!! Form::text('nombre',null,['class'=>'form-control','placeholder'=>'Num Int']) !!}
                    </div>
                </div>
                <div class="col-sm-3">
                    {!! Form::text('nombre',null,['class'=>'form-control','placeholder'=>'Colonia']) !!}
                </div>
            </div>
            <div class="form-group">
                {!! Form::label('',null,['class'=>'control-label col-sm-3']) !!}
                <div class="col-sm-3">
                    {!! Form::text('nombre',null,['class'=>'form-control','placeholder'=>'Ciudad']) !!}
                </div>
                <div class="col-sm-3">
                    {!! Form::text('nombre',null,['class'=>'form-control','placeholder'=>'Municipio']) !!}
                </div>
                <div class="col-sm-3">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    {!! link_to('trabajador/create', $title = 'Adjuntar',['class'=>'form-control btn btn-success',]) !!}
                </div>
                <div class="col-sm-3">
                </div>
            </div>
