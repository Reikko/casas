<?php $__env->startSection('444'); ?>
    <?php echo Form::model($lugar,['route'=>['fallo.update',$lugar->id],'method'=>'PUT']); ?>

    <div class="form-group">
        <?php echo Form::label('Lugar:'); ?>

        <?php echo Form::text('nom_defecto',null,['class'=>'form-control','placeholder'=>'Nombre del lugar','required'=>'true']); ?>
