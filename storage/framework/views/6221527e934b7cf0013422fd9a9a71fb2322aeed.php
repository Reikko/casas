    ...
    <div class="container">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <table class="table table-condensed table-bordered table-hover ">
                    ...
                    <tr>
                        ...
                        <?php if($errors->has('pago.'.$i)): ?>
                            <td>
                                <div class="form-group<?php echo e('pago.'.$i ? ' has-error' : ''); ?>">
                                    <?php echo e(old('pago.'.$i)); ?>

                                    <span class="help-block">
                                        <strong><?php echo e($errors->first('pago.'.$i)); ?></strong>
                                    </span>
                                </div>
                            </td>
                        <?php else: ?>
                        ...
                        <?php if($errors->has('porcentaje.'.$i)): ?>
                            <td>
                                <div class="form-group<?php echo e('porcentaje.'.$i ? ' has-error' : ''); ?>">
                                    <?php echo e(Form::text('porcentaje['.$i.']',old('porcentaje.'.$i),['class'=>'form-control','id'=> old('id_destajo.'.$i) ])); ?>
                        ...
                        <?php else: ?>
                            ...
                            <?php foreach($filasLote as $fl): ?>
                                <?php if($fl->id_destajo == $destajo->id): ?>
                                    <td>
                                        <?php echo e(Form::text('porcentaje['.$i.']', $fl->avance ,['class'=>'form-control','id' => $destajo->id])); ?>
                            ...
                            <?php if($ya == 1): ?>
                                <td>
                                    <?php echo e(Form::text('porcentaje['.$i.']', 0 ,['class'=>'form-control','id'=>$destajo->id])); ?>
                ...
                <?php echo Form::submit('Guardar',['class'=>'btn btn-primary btn-block','id'=>'envia','invisible']); ?>
