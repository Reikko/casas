                ...
                <ul class="nav navbar-nav">
                        ...
                        <?php else: ?>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><?php echo link_to_route('lugar.create', $title = 'Nuevo Lugar Casa'); ?></li>
                                    <li><?php echo link_to_route('lugar.index', $title = 'Mostrar Lugares Casa'); ?></li>
                                </ul>
                            </li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><?php echo link_to_route('fallo.create', $title = 'Nuevo Lugar Defecto'); ?></li>
                                    <li><?php echo link_to_route('fallo.index', $title = 'Mostrar Lugares Defecto'); ?></li>
                                </ul>
                            </li>
                        <?php endif; ?>
                </ul>
