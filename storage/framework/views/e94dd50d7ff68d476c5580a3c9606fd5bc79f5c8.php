<?php $__env->startSection('completo'); ?>
    ...
    <div class="row">
        ...
        <div class="col-sm-3">
            <?php echo link_to_route('tabla.show','Ver reporte',$reporte->id, ['class' => 'btn btn-primary btn-block']); ?>
                    ...
                    <table class="table table-bordered">
                        ...
                        <?php foreach($filas as $num => $fila): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo link_to('tabla/'.$reporte->id.'/edit/'.$fila->id,'Editar', ['class' => 'btn btn-primary btn-block']); ?>
                        ...
                        <tr class="info">
                            ...
                            <td width="250">
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn btn-primary">+</button>
                                    <?php echo link_to('tipofallo/1','Ver : Electrico', ['class' => 'btn btn-primary','id'=>'descrip']); ?>
